$(function() {
  ...
  var springfox = {
    ...
    "securityConfig": function(onSuccess, onError) {
      $.ajax({
        url: this.apiUrl + "/swagger-resources/configuration/security",
        dataType: 'json',
        success: onSuccess,
        error: onError
      });
    ...
    "uiConfig": function(onSuccess, onError) {
      $.ajax({
        url: this.apiUrl + "/swagger-resources/configuration/ui",
        dataType: 'json',
        success: onSuccess,
        error: onError
      });
  ...
  function initializeBaseUrl() {
    var relativeLocation = springfox.apiUrl;
    ...
    $.getJSON(relativeLocation + "/swagger-resources", function(data) {
      ...
      $.each(data, function(i, resource) {
        var option = $('<option></option>')
            .attr("value", maybePrefix("/api-docs", relativeLocation))
            .text(resource.name + " (" + "/api-docs" + ")");
